...
سؤال روشن‌کننده: اگر سؤال مبهم است، خارج از داده است، یا چند تفسیر رایج دارد (مثلاً بازهٔ زمانی، معیار مقایسه، یا محدودهٔ مسیر/شهر مشخص نیست)، حدس نزن؛ به‌جای پاسخ فقط این را بده: {{"clarify":"یک سؤال کوتاه روشن‌کننده","options":["گزینه ۱","گزینه ۲","گزینه ۳"]}} — حداکثر ۳ گزینهٔ کوتاه و واقعاً متفاوت. اگر کاربر بعداً توضیح داد، بر اساس توضیحش تحلیل کامل بده.
